...
//! Credit to Arkworks' implementation at:
//! https://github.com/arkworks-rs/algebra/blob/master/ec/src/msm/variable_base/stream_pippenger.rs
//!
use ark_ec::{AffineCurve, msm};
